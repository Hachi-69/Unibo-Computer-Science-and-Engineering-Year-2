...
<body>
    ...
    <div class="scheda">
        ...
        <div class="info-group"><span class="info-label">Specie:</span>
            <?php echo htmlspecialchars($esemplare['Nome_Specie_Fauna']); ?></div>
        <div class="info-group"><span class="info-label">Sesso:</span>
            <?php echo $esemplare['Sesso'] == 'M' ? 'Maschio' : 'Femmina'; ?></div>
        <div class="info-group"><span class="info-label">Data di Nascita:</span>
            <?php echo htmlspecialchars($esemplare['Data_Nascita']); ?></div>
        <div class="info-group"><span class="info-label">Stato di Salute Corrente:</span>
            <?php echo htmlspecialchars($esemplare['Stato_Salute']); ?></div>
        <div class="info-group"><span class="info-label">Visite Cliniche Totali Subite:</span>
            <?php echo htmlspecialchars($esemplare['Totale_Visite_Subite']); ?></div>
