...
public final class Transformers {
     ...
     * {@link Iterable}, obtaining multiple elements, and then builds a "flat"
     * list of these transformed elements. For instance, {@code [1, 2, 3, 4, 5]}
     * could use {@code flattenTransform} to transform only the odd numbers into
     * squares, passing a function that returns an empty {@link List} for even
     * numbers and a List with the square of the input otherwise, obtaining as
     * output {@code [1, 9, 25]}.
     *
     * @param base the elements on which to operate
     * @param transformer the {@link Function} to apply to each element. It must
     * transform the elements into a (possibly empty) collection of other
     * elements.
    ...
    /**
     * A function that applies a transformation to each element of an
     * {@link Iterable}, returning a list of these transformed elements. For
     * instance, {@code [1, 2, 3, 4, 5]} could use {@code transform} to produce
     * a list of squares by passing a function that computes the square of the
     * input, thus obtaining {@code [1, 4, 9, 16, 25]}.
     * <b>NOTE:</b> this function is a special flattenTransform whose function
     * always return a list with a single element
     *
     * @param base the elements on which to operate
    ...
    /**
     * A function that takes an iterable of collections, and returns a flatten
     * list of the elements of the inner collections. For instance,
     * {@code [[1], [2, 3], [4, 5], []]} could use {@code flatten} to produce a
     * flat list, thus obtaining {@code [1, 2, 3, 4, 5]}.
     * <b>NOTE:</b> this function is a special flattenTransform whose input is
     * an iterable of collections, and whose function simply returns each
     * collection (identity).
     *
     * @param base the collections on which to operate
     * @param <I> type of the collection elements
     * @return A flattened list with the elements of each collection in the
     * input
     */
     ...
     * returning a list containing only the elements that pass the test. For
     * instance, {@code [1, 2, 3, 4, 5]} could use {@code select} to filter only
     * the odd numbers, thus obtaining {@code [1, 3, 5]}.
     * <b>NOTE:</b> this function is a special flattenTransform whose function
     * returns a list with a single element if the element passes the test, and
     * an empty list otherwise.
     *
     * @param base the elements on which to operate
     * @param test the {@link Function} to use to test whether the elements
     * should be selected.
    ...
    /**
     * A function that applies a test to each element of an {@link Iterable},
     * returning a list containing only the elements that do not pass the test.
     * For instance, {@code [1, 2, 3, 4, 5]} could use {@code select} to reject
     * all the even numbers, thus obtaining {@code [1, 3, 5]}.
