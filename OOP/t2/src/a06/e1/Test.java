...
public class Test {
	...
	/*
	 * Implementare l'interfaccia ZipCombinerFactory come indicato nel metodo
	 * initFactory qui sotto.
	 * Realizza una factory per un concetto di ZipCombiner, ossia una funzionalità
	 * per combinare
	 * due liste in una lista risultante, come variante del classico "zip" (che è la
	 * prima semplice
	 ...
	 * - la buona progettazione della soluzione, cercando di riusare codice, e
	 * desumere l'algoritmo generico che cattura
	 * tutti e 4 i casi.
	 * 
	...
	public void testClassical() {
		...
		// una lista di coppie formata da un elemento di l1 (0,1,2) e uno di l2
		// (a,b,c,d), assumendo l2 non più piccola di l1
		// il risulato è quindi la lista di coppie (<0,a>, <1,b>, <2,c>), mentre la
		// parte restante di l2 viene sempre scartata.
		assertEquals(
	...
	public void testFilter() {
		...
		// se l'elemento di l1 (0,1,2,3) è pari, allora si prende il corrispondente
		// elemento di l2 (a,b,c,d,...), e gli si aggiunge un ";"
		assertEquals(
				List.of("a;", "c;"),
	...
	public void testTaker() {
		...
		// preso un numero 'n' da l1 (1,0,3), crea la lista dei prossimi 'n' numeri di
		// l2 (a,b,c,d,...)
		// ossia prende da l2 la sottolista di lunghezza 1 (a), poi 0 (), poi 3 (b,c,d),
		// scartando al solito il resto
		assertEquals(
	...
	public void testCounter() {
		...
		// preso un elemento di l1 (A,B,C), conta quanti elementi consecutivi ci sono in
		// l2 fino al prossimo '0'
		// ossia la prima volta 10, 20 (lunghezza 2), poi 30,40,50 (lunghezza 3), infine
		// 60 (lunghezza 1)
		assertEquals(
